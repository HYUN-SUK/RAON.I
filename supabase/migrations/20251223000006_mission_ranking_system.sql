...
DROP POLICY IF EXISTS "Users can view all likes" ON public.mission_likes;
CREATE POLICY "Users can view all likes"
    ON public.mission_likes FOR SELECT
    USING (true);

DROP POLICY IF EXISTS "Users can like missions" ON public.mission_likes;
CREATE POLICY "Users can like missions"
    ON public.mission_likes FOR INSERT
    WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can unlike missions" ON public.mission_likes;
...
DROP FUNCTION IF EXISTS toggle_mission_like(UUID) CASCADE;
...
DROP FUNCTION IF EXISTS process_mission_ranking(UUID) CASCADE;
