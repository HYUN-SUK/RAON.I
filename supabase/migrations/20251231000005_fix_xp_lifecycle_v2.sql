...
DROP FUNCTION IF EXISTS grant_user_reward(UUID, INTEGER, INTEGER, INTEGER, TEXT, UUID) CASCADE;
...
DROP FUNCTION IF EXISTS cascade_delete_point_history_on_mission_withdraw() CASCADE;
...
DROP FUNCTION IF EXISTS cascade_delete_point_history_on_post_delete() CASCADE;
...
DROP FUNCTION IF EXISTS handle_point_history_deletion() CASCADE;
...
DROP FUNCTION IF EXISTS admin_force_delete_post(UUID) CASCADE;
