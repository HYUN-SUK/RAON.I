...
DROP FUNCTION IF EXISTS get_trending_missions() CASCADE;
...
DROP FUNCTION IF EXISTS admin_delete_comment(UUID) CASCADE;
...
DROP FUNCTION IF EXISTS admin_withdraw_mission_participation(UUID, UUID) CASCADE;
...
DROP FUNCTION IF EXISTS admin_delete_creator_comment(UUID) CASCADE;
