...
DROP POLICY IF EXISTS "Allow public select user_missions" ON public.user_missions;
CREATE POLICY "Allow public select user_missions" ON public.user_missions
    FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow public insert user_missions" ON public.user_missions;
CREATE POLICY "Allow public insert user_missions" ON public.user_missions
    FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Allow public update user_missions" ON public.user_missions;
