...
-- 6. Updated_at 트리거
DROP FUNCTION IF EXISTS update_schedule_updated_at() CASCADE;
...
-- 7. 일정 UPSERT RPC
DROP FUNCTION IF EXISTS upsert_schedule(UUID, TEXT, TEXT, TEXT, DOUBLE, DOUBLE, DATE, DATE, TEXT, UUID, UUID) CASCADE;
...
-- 8. 찜 토글 RPC
DROP FUNCTION IF EXISTS toggle_campground_favorite(UUID, UUID) CASCADE;
