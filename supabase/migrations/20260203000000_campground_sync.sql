...
-- 캠핑장 동기화 RPC (Upsert)
DROP FUNCTION IF EXISTS upsert_campground(TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT[], BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, TEXT[], TEXT[], INTEGER, TEXT) CASCADE;
