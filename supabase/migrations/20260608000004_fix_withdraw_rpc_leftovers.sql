-- Migration: Fix Withdraw RPC Leftovers
-- Date: 2026-06-08
-- Description: Update fn_withdraw_user to purge user_camping_profiles and camping_records before auth.users deletion to prevent foreign key errors.
...
BEGIN
    ...
    DELETE FROM public.creators WHERE id = p_user_id;
    DELETE FROM public.user_camping_profiles WHERE user_id = p_user_id;
    DELETE FROM public.camping_records WHERE user_id = p_user_id;
