...
export const getApiConfigs = () => {
  ...
  return [
    ...
    { name: 'KTO_POPULARITY', label: '명소(지자체 인기도)', url: `http://apis.data.go.kr/B551011/TarRlteTarService1/areaBasedList1?serviceKey=${process.env.PUBLIC_DATA_API_KEY}&areaCd=34&signguCd=34330&baseYm=202504&numOfRows=1&_type=json&MobileOS=ETC&MobileApp=RAONAI` },
