...
export default async function SiteDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (id === 'air-group') {
        ...
        site = {
            id: siteData.id,
            name: siteData.name,
            type: (siteData.site_type as any) || 'AUTO',
            ...
            weekday: siteData.weekday || undefined,
            weekend: siteData.weekend || undefined,
            peakWeekday: siteData.peak_weekday || undefined,
            peakWeekend: siteData.peak_weekend || undefined
        };
    }
