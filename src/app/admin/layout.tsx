...
import { Home, Calendar, CreditCard, Settings, Users, ShoppingBag, Bell, Shield, LogOut, Star, Wrench, Tent, Send, Activity } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
            ...
            <aside className="bg-gray-900 text-white w-full md:w-64 flex-shrink-0 flex flex-col">
                ...
                <nav className="p-2 space-y-1 overflow-x-auto md:overflow-visible flex md:block whitespace-nowrap md:whitespace-normal flex-1">
                    ...
                    <NavLink href="/admin/push" icon={<Send size={18} />} label="알림 발송" />
                    <NavLink href="/admin/automation/logs" icon={<Activity size={18} />} label="자동화 현황" />
