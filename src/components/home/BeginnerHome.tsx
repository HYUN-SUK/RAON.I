            ...
            <main className="flex-1 pb-24 overflow-y-auto scrollbar-hide">
                ...
                <div className="px-4 -mt-8 relative z-30 mb-4">
                    <button
                        ...
                        className="w-full flex items-center justify-between px-6 py-6 bg-[#C5DEC9] dark:bg-zinc-900 border-[3px] border-[#224732] rounded-2xl shadow-[0_6px_20px_-4px_rgba(0,0,0,0.12)] hover:bg-[#b5d5ba] dark:hover:bg-zinc-800/80 active:scale-[0.99] transition-all duration-200 text-left cursor-pointer group"
                    >
                ...
                <div className="px-4 mb-4">
                    <button
                        ...
                        className="w-full flex items-center justify-between px-6 py-6 bg-[#F7ECE1] dark:bg-zinc-900 border-[3px] border-[#A76D38] rounded-2xl shadow-[0_6px_20px_-4px_rgba(0,0,0,0.12)] hover:bg-[#ecdccf] dark:hover:bg-zinc-800/80 active:scale-[0.99] transition-all duration-200 text-left cursor-pointer group"
                    >
                        <div className="flex items-center gap-4">
                            <div className="p-3 bg-[#A76D38] text-white rounded-xl">
                                <Calendar className="w-6 h-6" />
                            </div>
                            <div>
                                <h3 className="text-lg font-black text-[#A76D38] dark:text-stone-200 tracking-tight leading-tight">
                                    여행계획 자동생성<br />· 여행일정 관리
                                </h3>
                            </div>
                        </div>
                        <div className={`text-[#A76D38] dark:text-stone-300 p-2 bg-white/60 dark:bg-zinc-950/60 rounded-full transition-transform duration-300 ${isScheduleExpanded ? 'rotate-180' : 'animate-pulse'}`}>
                            <ChevronDown className="w-5 h-5" />
                        </div>
                    </button>
                </div>
                ...
                <div className="px-4 mb-8">
                    <button
                        ...
                        className="w-full flex items-center justify-between px-6 py-6 bg-[#F8F3E3] dark:bg-zinc-900 border-[3px] border-[#8E7544] rounded-2xl shadow-[0_6px_20px_-4px_rgba(0,0,0,0.12)] hover:bg-[#ede3cd] dark:hover:bg-zinc-800/80 active:scale-[0.99] transition-all duration-200 text-left cursor-pointer group"
                    >
                        <div className="flex items-center gap-4">
                            <div className="p-3 bg-[#8E7544] text-white rounded-xl">
                                <ChefHat className="w-6 h-6" />
                            </div>
                            <div>
                                <h3 className="text-lg font-black text-[#8E7544] dark:text-stone-200 tracking-tight leading-tight">소소한 챙김</h3>
                                <p className="text-xs text-stone-500 dark:text-stone-400 mt-1 font-medium">주간 미션, 캠핑 요리 레시피, 놀이 탐색기</p>
                            </div>
                        </div>
                        <div className="text-[#8E7544] dark:text-stone-300 p-2 bg-white/60 dark:bg-zinc-950/60 rounded-full">
