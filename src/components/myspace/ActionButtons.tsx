    ...
    return (
        <div className="grid grid-cols-2 gap-4 px-6 py-6 -mt-8 relative z-20">
            <button
                ...
                className="flex items-center justify-center gap-2.5 bg-gradient-to-br from-[#1C4526] to-[#2D5A3A] text-white py-4 rounded-2xl shadow-lg shadow-brand-1/25 hover:shadow-xl hover:scale-[1.02] active:scale-95 transition-all duration-300 w-full"
            >
