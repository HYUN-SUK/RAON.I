...
- [ ] **Phase 7: 카테고리별 세부 선별 로직 검증 (다음 세션 예정)**
    - [ ] **[마트/병원/주유소/축제]** 3일 전 캐싱 2부 선별 로직 정밀 점검
    - [ ] **[리스트 검증]** 실제 생성된 리스트와 로직 대조를 통한 데이터 품질 확인
    - [ ] **[인기도 엔진]** 명소 인기도 엔진 v2 전국 보급 및 스코어 안착 확인 (이어서 진행)
